...
| --- | --- | --- |
| Owned packages in list | `internal/brand`, `internal/id`, `internal/ai/capability`, `internal/completion`, `internal/scheduler`, `internal/fakecoder` | grow only when we add first-party code |
