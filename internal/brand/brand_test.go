...
func TestExportedIdentity(t *testing.T) {
	...
	cases := []struct {
		...
		{"EnvStripeSecretKey", brand.EnvStripeSecretKey, "INITAGENT_STRIPE_SECRET_KEY"},
		{"EnvStripeWebhookSecret", brand.EnvStripeWebhookSecret, "INITAGENT_STRIPE_WEBHOOK_SECRET"},
		{"EnvStripePriceStarter", brand.EnvStripePriceStarter, "INITAGENT_STRIPE_PRICE_STARTER"},
		{"EnvStripePriceTeam", brand.EnvStripePriceTeam, "INITAGENT_STRIPE_PRICE_TEAM"},
