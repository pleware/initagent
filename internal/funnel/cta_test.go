...
func TestResolveCTA(t *testing.T) {
	...
	cases := []struct {
		...
		{"self_host", "http://localhost:21003/developers", KindCTASelfHost, "http://localhost:21003/developers", true},
		{"self_host", "http://127.0.0.1:21003/developers", KindCTASelfHost, "http://127.0.0.1:21003/developers", true},
