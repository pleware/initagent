...
func (s *Server) routes() {
	...
	m.HandleFunc("GET /api/admin/orgs/{id}", s.requireCredential(s.handleGetOrgAdmin))
	m.HandleFunc("POST /api/admin/orgs/{id}/suspend", s.requireCredential(s.handleSuspendOrg))
	m.HandleFunc("POST /api/admin/orgs/{id}/resume", s.requireCredential(s.handleResumeOrg))
	m.HandleFunc("PATCH /api/admin/orgs/{id}/plan", s.requireCredential(s.handleSetOrgPlan))
	m.HandleFunc("GET /api/admin/kpis", s.requireCredential(s.handleAdminKPIs))
	m.HandleFunc("GET /api/admin/skills", s.requireCredential(s.handleAdminListSkills))
